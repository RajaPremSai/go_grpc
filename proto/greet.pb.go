...
const file_proto_greet_proto_rawDesc = "" +
	...
	"\bmessages\x18\x01 \x03(\tR\bmessages2\xe3\x02\n" +
	"\fGreetService\x12@\n" +
	"\bSayHello\x12\x16.greet_service.NoParam\x1a\x1c.greet_service.HelloResponse\x12W\n" +
	"\x1bSayHelloServerSideStreaming\x12\x18.greet_service.NamesList\x1a\x1c.greet_service.HelloResponse0\x01\x12X\n" +
	"\x1bSayHelloClientSideStreaming\x12\x1b.greet_service.HelloRequest\x1a\x1a.greet_service.MessageList(\x01\x12^\n" +
	"\x1dSayHelloBidirectionalStraming\x12\x1b.greet_service.HelloRequest\x1a\x1c.greet_service.HelloResponse(\x010\x01B\tZ\a./protob\x06proto3"
...
var file_proto_greet_proto_depIdxs = []int32{
	...
	3, // 1: greet_service.GreetService.SayHelloServerSideStreaming:input_type -> greet_service.NamesList
	2, // 2: greet_service.GreetService.SayHelloClientSideStreaming:input_type -> greet_service.HelloRequest
	2, // 3: greet_service.GreetService.SayHelloBidirectionalStraming:input_type -> greet_service.HelloRequest
	1, // 4: greet_service.GreetService.SayHello:output_type -> greet_service.HelloResponse
	1, // 5: greet_service.GreetService.SayHelloServerSideStreaming:output_type -> greet_service.HelloResponse
	4, // 6: greet_service.GreetService.SayHelloClientSideStreaming:output_type -> greet_service.MessageList
	1, // 7: greet_service.GreetService.SayHelloBidirectionalStraming:output_type -> greet_service.HelloResponse
